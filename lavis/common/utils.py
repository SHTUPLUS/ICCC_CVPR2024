...
def create_file_symlink(file1, file2):
    ...
    try:
        ...
        logger.info(f"Could NOT create symlink. Error: {e}")
    ...
    if file_ext == ".txt":
        ...
        if mmap_mode:
            try:
                ...
                logger.info("Could not mmap without g_pathmgr. Trying without mmap")
                with g_pathmgr.open(filename, "rb") as fopen:
...
def makedir(dir_path):
    ...
    try:
        ...
        logger.info(f"Error creating directory: {dir_path}")
    return is_success
...
def cleanup_dir(dir):
    ...
    if os.path.exists(dir):
        ...
        shutil.rmtree(dir)
    logger.info(f"Deleted contents of directory: {dir}")
