...
class Blip2T5(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        ...
        "vqa_flant5xl": "configs/models/blip2/blip2_vqa_flant5xl.yaml"
    ...
    def forward(self, samples):
        ...
        if self._inference_method == "query_generate":
    ...
    def from_config(cls, cfg):
        ...
        inference_method = cfg.get("inference_method", "rank")
