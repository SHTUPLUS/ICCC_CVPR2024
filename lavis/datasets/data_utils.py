...
def extract_archive(from_path, to_path=None, overwrite=False):
    ...
    if from_path.endswith((".tar.gz", ".tgz")):
        logger.info("Opening tar file {} to {}.".format(from_path, to_path))
        ...
        logger.info("Opening zip file {} to {}.".format(from_path, to_path))
        ...
        logger.info("Opening gz file {} to {}.".format(from_path, to_path))
