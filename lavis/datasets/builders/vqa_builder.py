...
from lavis.datasets.datasets.coco_vqa_datasets import COCOVQADataset, COCOVQAEvalDataset, VisualSpatialReasoningDataset
...
class VSRBuilder(BaseDatasetBuilder):
    eval_dataset_cls = VisualSpatialReasoningDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/vsr/defaults_vsr.yaml",
    }